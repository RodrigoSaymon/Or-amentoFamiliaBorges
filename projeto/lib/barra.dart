...
class DemoMWBottomNavigationScreen7 extends StatefulWidget {
  ...
  @override
  _DemoMWBottomNavigationScreen7State createState() =>
      _DemoMWBottomNavigationScreen7State();
}

class _DemoMWBottomNavigationScreen7State
    extends State<DemoMWBottomNavigationScreen7> {
  ...
  void initState() {
    ...
    sampleData.add(
      SampleListModel(
        title: "Gallery",
        launchWidget: Text("Gallery View",
            style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
        icon: Icons.add_box,
        colors: Colors.red,
      ),
    ...
    sampleData.add(
      SampleListModel(
        title: "Favorite",
        launchWidget: Text("Favorite View",
            style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
        icon: Icons.favorite,
        colors: Colors.red,
      ),
